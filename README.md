...
- **Vertical stack towers.** Some oases stage 6–14 identical items as a vertical column. Bite the base and the tower slumps down one unit at a time — a rapid chain of swallows that stokes your combo. Tall enough (8+ alive), the whole column topples away from you instead, its units scattering across the ground in a line for you to chase. A rare desert beacon tower (up to 24 units) stands alone as a navigable landmark between oases.
